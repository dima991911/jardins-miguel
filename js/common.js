$(document).ready(function() {
	...
	$("#servicios .left").animated("bounceInLeft");
	$("#servicios .right").animated("bounceInRight");
	$(".como").animated("bounceInLeft");
	$(".logo2").animated("zoomIn");
	...
	$(".toggle_mnu").click(function() {
		if ($(".top_mnu").is(":visible")) {
			$(".top_text").css("opacity", "1");
			$(".top_mnu").fadeOut(600);
			$(".top_mnu li a").removeClass("fadeInDown animated");
		} else {
			$(".top_text").css("opacity", ".1");
			$(".top_mnu").fadeIn(600);
